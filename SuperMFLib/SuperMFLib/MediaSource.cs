...
{
    public class MediaSource : COMDisposable<IMFMediaSource>
    {
        public MediaSource(IMFMediaSource instance) : base(instance) { }

        public PresentationDescriptor CreatePresentationDescriptor()
        {
            IMFPresentationDescriptor presentationDescriptorInstance;

            instance.CreatePresentationDescriptor(out presentationDescriptorInstance);

            return new PresentationDescriptor(presentationDescriptorInstance);
        }
    }
}
